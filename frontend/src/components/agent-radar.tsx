...
const AGENTS: AgentMeta[] = [
  {
    ...
    icon: Database,
    activeBorder: "border-cyan-500/80 dark:border-cyan-400/70 bg-cyan-500/[0.06] dark:bg-cyan-500/10",
    glowShadow: "shadow-[0_0_20px_rgba(6,182,212,0.25)] dark:shadow-[0_0_24px_rgba(6,182,212,0.35)]",
  ...
  },
  {
    ...
    icon: Cpu,
    activeBorder: "border-indigo-500/80 dark:border-indigo-400/70 bg-indigo-500/[0.06] dark:bg-indigo-500/10",
    glowShadow: "shadow-[0_0_20px_rgba(99,102,241,0.25)] dark:shadow-[0_0_24px_rgba(129,140,248,0.35)]",
  ...
  },
  {
    ...
    icon: Target,
    activeBorder: "border-amber-500/80 dark:border-amber-400/70 bg-amber-500/[0.06] dark:bg-amber-500/10",
    glowShadow: "shadow-[0_0_20px_rgba(245,158,11,0.25)] dark:shadow-[0_0_24px_rgba(245,158,11,0.35)]",
  ...
  },
  {
    ...
    icon: BarChart3,
    activeBorder: "border-emerald-500/80 dark:border-emerald-400/70 bg-emerald-500/[0.06] dark:bg-emerald-500/10",
    glowShadow: "shadow-[0_0_20px_rgba(16,185,129,0.25)] dark:shadow-[0_0_24px_rgba(16,185,129,0.35)]",
...
export function AgentRadar() {
  ...
  if (!isProcessing && Object.values(agentStates).every((st) => st === "idle")) {
    return null;
  }
  ...
  return (
    <div className="relative rounded-xl p-4 mx-4 mb-3 border border-border/80 bg-card shadow-md overflow-hidden transition-all duration-300">
      {/* Background ambient gradient glow */}
      <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/5 via-indigo-500/5 to-emerald-500/5 pointer-events-none" />
      ...
      <div className="relative flex items-center justify-between mb-3.5">
        ...
        <div className="flex items-center gap-3">
          {executionMode && (
            <span className="text-[9px] font-mono px-2 py-0.5 rounded bg-secondary text-secondary-foreground border border-border/50">
              {executionMode}
            </span>
          )}
            ...
            >
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[8px] text-muted-foreground truncate">{agent.shortRole}</p>
                </div>
              </div>
